...
key and `APP_SECRET` stays empty — to wire it, edit the relevant component's container
`secretKeyRef` in `.devops/chart/base/deployments.yaml` to point at the Secret/key you set.
